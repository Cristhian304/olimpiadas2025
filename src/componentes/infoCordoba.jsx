...
const InfoCordoba = ({onVolver,irAlCarrito,onAgregar,irAPendientes}) => {
  return (
      ...
      <div className="contenido-info">
        ...
        <div className="tarjeta-info">
          <div className="col-izq">
            <p><strong>Paquete a Cordoba - 3 noches 3*</strong></p>
            <p>Paga en 9 cuotas sin interés</p>
            <ul>
              <li><strong>Duración:</strong> 3 noches</li>
              <li><strong>Destinos:</strong> Carlos Paz</li>
            ...
            <ul>
              <li>Pasaje aéreo Buenos Aires/ Cordoba/ Buenos Aires con Aerolíneas Argentinas</li>
          ...
          <div className="col-der">
            <h2>Cordoba</h2>
            <hr />
            <p className="precio"><strong>Precio final: </strong>$499.156,56</p>
